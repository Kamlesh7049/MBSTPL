...
import { FaTasks, FaHome, FaUserPlus, FaSignOutAlt } from "react-icons/fa"; 
  ...
  return (
    <>
      ...
      <Navbar bg="dark" variant="dark" expand="lg" className="mb-4 shadow">
        <Container>
          <Navbar.Brand href="#">DashBoardUser</Navbar.Brand>
            ...
            <Card className="shadow">
              ...
              <Card.Body>
                <Nav className="flex-column">
                  ...
                  >
                    <FaHome className="me-2" /> Assigned Task
                  </Nav.Link>
                  {/* <Nav.Link
                    as={Link}
                    to="addtask"
